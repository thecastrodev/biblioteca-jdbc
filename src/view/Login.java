	...
	public Login() {
		...
		btnNewButton_login.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textField_usuario.getText()!=null && 
						!textField_usuario.getText().isEmpty() && 
						textField_senha.getText()!=null &&
					...
					Opcoes.setVisible(true);
						...
						JOptionPane.showMessageDialog(btnNewButton_login,"Usuario ou senha incorretos!","Aviso", JOptionPane.WARNING_MESSAGE);
					}
			}
		});
